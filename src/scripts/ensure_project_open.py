            ...
            try:
                ...
                try:
                     ...
                     try:
                         ...
                         print("DEBUG: open() with update_flags failed, trying without flags...")
                         try:
                             opened_project = script_engine.projects.open(target_project_path, True, True)
                         except TypeError:
                             opened_project = script_engine.projects.open(target_project_path)
